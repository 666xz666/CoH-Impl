...
Please only output {{id}} of the historical events that your inferred answers are based on. Note that you must only output no more than {top_n} {{id}} without any explanation. Please strictly follow the above demands for output.
"""
...
Please only output {{id}} of the historical chains that your inferred answers are based on. Note that you must only output no more than {top_n} {{id}} without any explanation. Please strictly follow the above demands for output.
"""
